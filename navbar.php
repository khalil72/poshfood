...
<nav class="navbar navbar-expand-lg py-2 pb-3 bg-white shadow-sm ftco_navbar"
     id="ftco-navbar"
  ...
  <div class="container d-flex align-items-center">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="ftco-nav">
      ...
      <!-- MENU -->
      <ul class="navbar-nav align-items-center gap-lg-4 me-lg-3">
        <li class="nav-item">
      ...
      <div class="navbar-lang d-flex align-items-center mx-3">
